...
// API User Info
apiRouter.put("/api/v1/profile/update", uploadOnMemory.single("picture"), controllers.api.v1.userController.updateInfoAkun);
//get user id
apiRouter.get("/api/v1/users/:id", controllers.api.v1.userController.findUserById);

// API CRUD Product
apiRouter.get("/api/v1/products", controllers.api.v1.productController.findAllProduct); // Find All Product in Homepage
apiRouter.get("/api/v1/product", controllers.api.v1.productController.findMyProduct); // Find Product By IdSeller in Daftar Jual
apiRouter.post("/api/v1/product", uploadOnMemory.array("picture", 4), controllers.api.v1.productController.addProduct); // Add Product
apiRouter.get("/api/v1/product/:id", controllers.api.v1.productController.findOneProduct);

apiRouter.put("/api/v1/product/update/:id", uploadOnMemory.array("picture", 4), controllers.api.v1.productController.updateProduct); // Edit Product
apiRouter.put("/api/v1/products/cloudinary", uploadOnMemory.array("picture", 4), controllers.api.v1.productController.uploadProductImages); // Upload Product Images

//get product list
apiRouter.get("/api/v1/products", controllers.api.v1.productController.findAllProduct);

//get filtered product list
apiRouter.get("/api/v1/products/filter/:category", controllers.api.v1.productController.findProductsByCategory);
...
apiRouter.post("/api/v1/transaction", controllers.api.v1.transaksiController.createTransaksi);

//find one transaction
apiRouter.get("/api/v1/transaction/:id", controllers.api.v1.transaksiController.findOneTransaction);
